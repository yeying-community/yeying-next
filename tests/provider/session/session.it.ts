...
import {SessionProvider} from "../../../src/provider/session/session";
...
const sessionId = "333422fc-a425-4937-b2d9-5584a9bf6346"

describe('Session', () => {
    it('create', async () => {
        const sessionProvider = new SessionProvider(provider)
