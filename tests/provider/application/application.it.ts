...
import {IdentityManager, LanguageCodeEnum, ProviderOption, ServiceCodeEnum, UserProvider} from "../../../src";
...
import {convertApplicationMetadataFromIdentity} from "../../../src/identity/model";
...
beforeAll(async () => {
  ...
  const serviceIdentity = await identityManager.createIdentity(password, applicationTemplate)
