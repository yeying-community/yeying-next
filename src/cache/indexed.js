...
export class IndexedCache {
   ...
   */
  index(tableName, indexName, indexValue) {
    return new Promise((resolve, reject) => {
      let store = this.instance.transaction(tableName, 'readwrite').objectStore(tableName)
   ...
   * @param {string} indexValue 索引值
   */
  indexAll(tableName, indexName, indexValue) {
    return new Promise((resolve, reject) => {
      let store = this.instance.transaction(tableName, 'readwrite').objectStore(tableName)
   ...
   * @param {string} indexValue 索引值
   */
  cursorIndex(tableName, indexName, indexValue, direction, callback) {
    return new Promise((resolve, reject) => {
   ...
   */
  cursorIndexByPage(tableName, indexName, indexValue, page, pageSize) {
    return new Promise((resolve, reject) => {
      let counter = 0 // 计数器
   ...
   * @param {string} indexName 索引名称
   */
  updateByIndex(tableName, indexName, data) {
    return new Promise((resolve, reject) => {
   ...
   *
   */
  deleteByIndex(tableName, indexName, indexValue) {
    return new Promise((resolve, reject) => {
   ...
   *
   */
  deleteAllByIndex(tableName, indexName, indexValue) {
    return new Promise((resolve, reject) => {
      const transaction = this.instance.transaction([tableName], 'readwrite')
      const objectStore = transaction.objectStore(tableName)
      let index = objectStore.index(indexName)
   ...
   */
  deleteByKey(tableName, keyValue) {
    return new Promise((resolve, reject) => {
   ...
   * @param {object} indexValue 索引值
   */
  deleteByCursorIndex(tableName, indexName, indexValue, callback) {
    return new Promise((resolve, reject) => {
      let store = this.instance.transaction(tableName, 'readwrite').objectStore(tableName)
      let request = store.index(indexName).openCursor(IDBKeyRange.only(indexValue))
      request.onsuccess = (e) => {
