...
export type LinkMetadata = Message<"yeying.api.asset.LinkMetadata"> & {
   ...
   * 分享链接创建时间
   *
   * @generated from field: string createAt = 7;
   */
  createAt: string;
