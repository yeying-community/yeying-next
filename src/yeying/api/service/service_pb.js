...
goog.exportSymbol('proto.yeying.api.service.SearchCondition', null, global);
...
goog.exportSymbol('proto.yeying.api.service.WhoamiResponseBody', null, global);
/**
 ...
 * @constructor
 */
proto.yeying.api.service.WhoamiResponseBody = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.yeying.api.service.WhoamiResponseBody, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.yeying.api.service.WhoamiResponseBody.displayName = 'proto.yeying.api.service.WhoamiResponseBody';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.yeying.api.service.SearchCondition = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.yeying.api.service.SearchCondition, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.yeying.api.service.SearchCondition.displayName = 'proto.yeying.api.service.SearchCondition';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 */
proto.yeying.api.service.WhoamiRequest.prototype.getHeader = function() {
 ...
 * @return {!proto.yeying.api.service.WhoamiRequest} returns this
*/
proto.yeying.api.service.WhoamiRequest.prototype.setHeader = function(value) {
 ...
 * @return {!proto.yeying.api.service.WhoamiRequest} returns this
 */
proto.yeying.api.service.WhoamiRequest.prototype.clearHeader = function() {
 ...
 * @return {boolean}
 */
proto.yeying.api.service.WhoamiRequest.prototype.hasHeader = function() {
...
proto.yeying.api.service.WhoamiResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
header: (f = msg.getHeader()) && yeying_api_common_message_pb.MessageHeader.toObject(includeInstance, f),
body: (f = msg.getBody()) && proto.yeying.api.service.WhoamiResponseBody.toObject(includeInstance, f)
  };
...
proto.yeying.api.service.WhoamiResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.yeying.api.service.WhoamiResponseBody;
      reader.readMessage(value,proto.yeying.api.service.WhoamiResponseBody.deserializeBinaryFromReader);
      msg.setBody(value);
      break;
    default:
      reader.skipField();
...
proto.yeying.api.service.WhoamiResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.yeying.api.service.WhoamiResponseBody.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {?proto.yeying.api.common.MessageHeader}
 */
proto.yeying.api.service.WhoamiResponse.prototype.getHeader = function() {
  return /** @type{?proto.yeying.api.common.MessageHeader} */ (
    jspb.Message.getWrapperField(this, yeying_api_common_message_pb.MessageHeader, 1));
};
...
*/
proto.yeying.api.service.WhoamiResponse.prototype.setHeader = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.yeying.api.service.WhoamiResponse} returns this
 */
proto.yeying.api.service.WhoamiResponse.prototype.clearHeader = function() {
  return this.setHeader(undefined);
};
 ...
 * @return {boolean}
 */
proto.yeying.api.service.WhoamiResponse.prototype.hasHeader = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {?proto.yeying.api.service.WhoamiResponseBody}
 */
proto.yeying.api.service.WhoamiResponse.prototype.getBody = function() {
  return /** @type{?proto.yeying.api.service.WhoamiResponseBody} */ (
    jspb.Message.getWrapperField(this, proto.yeying.api.service.WhoamiResponseBody, 2));
};


/**
 * @param {?proto.yeying.api.service.WhoamiResponseBody|undefined} value
 * @return {!proto.yeying.api.service.WhoamiResponse} returns this
*/
proto.yeying.api.service.WhoamiResponse.prototype.setBody = function(value) {
 ...
 * @return {!proto.yeying.api.service.WhoamiResponse} returns this
 */
proto.yeying.api.service.WhoamiResponse.prototype.clearBody = function() {
 ...
 * @return {boolean}
 */
proto.yeying.api.service.WhoamiResponse.prototype.hasBody = function() {
 ...
 * @return {!Object}
 */
proto.yeying.api.service.WhoamiResponseBody.prototype.toObject = function(opt_includeInstance) {
  return proto.yeying.api.service.WhoamiResponseBody.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.yeying.api.service.WhoamiResponseBody} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.yeying.api.service.WhoamiResponseBody.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.yeying.api.service.WhoamiResponseBody}
 */
proto.yeying.api.service.WhoamiResponseBody.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.yeying.api.service.WhoamiResponseBody;
  return proto.yeying.api.service.WhoamiResponseBody.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.yeying.api.service.WhoamiResponseBody} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.yeying.api.service.WhoamiResponseBody}
 */
proto.yeying.api.service.WhoamiResponseBody.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.yeying.api.service.WhoamiResponseBody.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.yeying.api.service.WhoamiResponseBody.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.yeying.api.service.WhoamiResponseBody} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.yeying.api.service.WhoamiResponseBody.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getStatus();
  if (f != null) {
    writer.writeMessage(
 ...
 */
proto.yeying.api.service.WhoamiResponseBody.prototype.getStatus = function() {
 ...
 * @return {!proto.yeying.api.service.WhoamiResponseBody} returns this
*/
proto.yeying.api.service.WhoamiResponseBody.prototype.setStatus = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.yeying.api.service.WhoamiResponseBody} returns this
 */
proto.yeying.api.service.WhoamiResponseBody.prototype.clearStatus = function() {
 ...
 * @return {boolean}
 */
proto.yeying.api.service.WhoamiResponseBody.prototype.hasStatus = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional ServiceMetadata service = 2;
 * @return {?proto.yeying.api.service.ServiceMetadata}
 */
proto.yeying.api.service.WhoamiResponseBody.prototype.getService = function() {
  return /** @type{?proto.yeying.api.service.ServiceMetadata} */ (
    jspb.Message.getWrapperField(this, proto.yeying.api.service.ServiceMetadata, 2));
};
 ...
 * @return {!proto.yeying.api.service.WhoamiResponseBody} returns this
*/
proto.yeying.api.service.WhoamiResponseBody.prototype.setService = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.yeying.api.service.WhoamiResponseBody} returns this
 */
proto.yeying.api.service.WhoamiResponseBody.prototype.clearService = function() {
 ...
 * @return {boolean}
 */
proto.yeying.api.service.WhoamiResponseBody.prototype.hasService = function() {
  return jspb.Message.getField(this, 2) != null;
};
...
proto.yeying.api.service.SearchRequestBody.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.yeying.api.service.SearchCondition;
 ...
 * @return {?proto.yeying.api.service.SearchCondition}
 */
proto.yeying.api.service.SearchRequestBody.prototype.getCondition = function() {
  return /** @type{?proto.yeying.api.service.SearchCondition} */ (
    jspb.Message.getWrapperField(this, proto.yeying.api.service.SearchCondition, 1));
};


/**
 * @param {?proto.yeying.api.service.SearchCondition|undefined} value
 * @return {!proto.yeying.api.service.SearchRequestBody} returns this
*/
proto.yeying.api.service.SearchRequestBody.prototype.setCondition = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.yeying.api.service.SearchRequestBody} returns this
 */
proto.yeying.api.service.SearchRequestBody.prototype.clearCondition = function() {
 ...
 * @return {boolean}
 */
proto.yeying.api.service.SearchRequestBody.prototype.hasCondition = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Object}
 */
proto.yeying.api.service.SearchCondition.prototype.toObject = function(opt_includeInstance) {
  return proto.yeying.api.service.SearchCondition.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.yeying.api.service.SearchCondition} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * @return {!proto.yeying.api.service.SearchCondition}
 */
proto.yeying.api.service.SearchCondition.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.yeying.api.service.SearchCondition;
  return proto.yeying.api.service.SearchCondition.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.yeying.api.service.SearchCondition} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.yeying.api.service.SearchCondition}
 */
proto.yeying.api.service.SearchCondition.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.yeying.api.service.SearchCondition.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.yeying.api.service.SearchCondition.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.yeying.api.service.SearchCondition} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.yeying.api.service.SearchCondition.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCode();
  if (f !== 0.0) {
    writer.writeEnum(
 ...
 */
proto.yeying.api.service.SearchCondition.prototype.getCode = function() {
