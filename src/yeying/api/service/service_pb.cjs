 ...
 * @const
 */
proto.yeying.api.service.ServiceMetadata.repeatedFields_ = [7];
...
proto.yeying.api.service.ServiceMetadata.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    apisList: (f = jspb.Message.getRepeatedField(msg, 7)) == null ? undefined : f,
    proxy: jspb.Message.getFieldWithDefault(msg, 8, ""),
    grpc: jspb.Message.getFieldWithDefault(msg, 9, ""),
    avatar: jspb.Message.getFieldWithDefault(msg, 10, ""),
    extend: jspb.Message.getFieldWithDefault(msg, 11, ""),
    created: jspb.Message.getFieldWithDefault(msg, 12, ""),
    checkpoint: jspb.Message.getFieldWithDefault(msg, 13, "")
  };
...
/**
 * optional yeying.api.common.ServiceCodeEnum code = 6;
 * @return {!proto.yeying.api.common.ServiceCodeEnum}
 */
proto.yeying.api.service.ServiceMetadata.prototype.getCode = function() {
  return /** @type {!proto.yeying.api.common.ServiceCodeEnum} */ (jspb.Message.getFieldWithDefault(this, 6, 0));
};
...
/**
 * repeated yeying.api.common.ApiCodeEnum apis = 7;
 * @return {!Array<!proto.yeying.api.common.ApiCodeEnum>}
 */
proto.yeying.api.service.ServiceMetadata.prototype.getApisList = function() {
  return /** @type {!Array<!proto.yeying.api.common.ApiCodeEnum>} */ (jspb.Message.getRepeatedField(this, 7));
};
