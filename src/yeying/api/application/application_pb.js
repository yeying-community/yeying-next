...
proto.yeying.api.application.ApplicationComment = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.yeying.api.application.ApplicationComment.repeatedFields_, null);
};
 ...
 * @const
 */
proto.yeying.api.application.ApplicationComment.repeatedFields_ = [1];
...
proto.yeying.api.application.ApplicationComment.toObject = function(includeInstance, msg) {
  var f, obj = {
auditorList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f,
...
/**
 * repeated string auditor = 1;
 * @return {!Array<string>}
 */
proto.yeying.api.application.ApplicationComment.prototype.getAuditorList = function() {
 ...
 */
proto.yeying.api.application.ApplicationComment.prototype.setAuditorList = function(value) {
 ...
 * @return {!proto.yeying.api.application.ApplicationComment} returns this
 */
proto.yeying.api.application.ApplicationComment.prototype.addAuditor = function(value, opt_index) {
 ...
 * @return {!proto.yeying.api.application.ApplicationComment} returns this
 */
proto.yeying.api.application.ApplicationComment.prototype.clearAuditorList = function() {
  return this.setAuditorList([]);
};
...
services: jspb.Message.getFieldWithDefault(msg, 13, ""),
avatar: jspb.Message.getFieldWithDefault(msg, 14, ""),
extend: jspb.Message.getFieldWithDefault(msg, 15, ""),
created: jspb.Message.getFieldWithDefault(msg, 16, ""),
checkpoint: jspb.Message.getFieldWithDefault(msg, 17, ""),
...
/**
 * optional yeying.api.common.ApplicationStatusEnum status = 10;
 * @return {!proto.yeying.api.common.ApplicationStatusEnum}
 */
proto.yeying.api.application.ApplicationMetadata.prototype.getStatus = function() {
  return /** @type {!proto.yeying.api.common.ApplicationStatusEnum} */ (jspb.Message.getFieldWithDefault(this, 10, 0));
};
